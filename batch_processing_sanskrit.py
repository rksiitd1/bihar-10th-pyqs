...
def main():
    ...
    input_folder = pathlib.Path("sanskrit_papers")
    output_folder = pathlib.Path("sanskrit_data")
    ...
    for year in years:
        for shift in shifts:
            input_pdf = input_folder / f"san_{year}{shift}.pdf"
            output_json = output_folder / f"san_{year}{shift}.json"
