...
def normalize_type(type_value: str) -> str:
    ...
    if type_lower in ["objective", "mcq", "multiple choice", "multiple_choice"]:
        ...
        return "long"
    elif type_lower in ["comprehension", "passage", "gadyansh"]:
        return "comprehension"
    elif type_lower in ["letter_writing", "letter", "patra_lekhan", "patra"]:
        return "letter_writing"
    elif type_lower in ["essay", "anuched", "paragraph"]:
        return "essay"
...
def main() -> None:
    source_path = os.path.join("sanskrit_pro", "sanskrit_all_years.json")
    output_dir = "sanskrit_pro_types"
