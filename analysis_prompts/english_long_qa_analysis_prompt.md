These are Class 10 Bihar Board English long-answer questions collected from the past 10 years of board examinations. Only long-answer type questions are included.

The dataset contains 33 questions. In the actual examination, 6 long-answer questions are asked, and students are required to attempt only 3.

Your task is to analyze all 33 questions and identify the 12 most important questions that students must study to maximize their chances of success.
...
Ensure that at least 3 questions from the set are likely to appear together in the exam.

Probability-Based Selection

Assign an estimated probability of appearance to each shortlisted question.

Select the final 12 questions such that the combined probability of being able to answer any 3 out of 6 exam questions is maximized.
...
Objective:
The goal is to ensure that a student who thoroughly prepares only these 12 questions will be able to confidently attempt all 3 required long-answer questions and achieve excellent marks in the examination.
