...
Ensure that at least 5 questions from the set are likely to appear together in the exam.

Probability-Based Selection

Assign an estimated probability of appearance to each shortlisted question.

Select the final 40 questions such that the combined probability of being able to answer any 5 out of 10 exam questions is maximized.
...
Objective:
The goal is to ensure that a student who thoroughly prepares only these 40 short-answer questions will be able to confidently attempt all 5 required questions and score very high marks in the examination.
