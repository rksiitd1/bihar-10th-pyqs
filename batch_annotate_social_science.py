...
# NCERT Class 10 Social Science Chapters (Combined)
...
def main():
    ...
    logger.info("Batch Social Science Question Annotator (Gemini) - Parallel")
    print("Batch Social Science Question Annotator (Gemini) - Parallel")
    print("="*40)
