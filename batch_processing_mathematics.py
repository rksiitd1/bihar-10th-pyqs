...
def main():
    ...
    input_folder = pathlib.Path("mathematics_papers")
    output_folder = pathlib.Path("mathematics_data")
    ...
    for year in years:
        for shift in shifts:
            input_pdf = input_folder / f"math_{year}{shift}.pdf"
            output_json = output_folder / f"math_{year}{shift}.json"
